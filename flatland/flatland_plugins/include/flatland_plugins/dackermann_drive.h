...
#ifndef FLATLAND_PLUGINS_DACKERMANN_DRIVE_H
#define FLATLAND_PLUGINS_DACKERMANN_DRIVE_H
...
class DackermannDrive : public flatland_server::ModelPlugin {
 public:
  Body* body_;
  ...
  bool invert_steering_angle_lr_;     ///< whether to invert steering angle
  bool invert_steering_angle_rr_;     ///< whether to invert steering angle
